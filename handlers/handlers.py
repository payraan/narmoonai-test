...
async def handle_analysis_type_selection(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if analysis_type == "classic":
        ...
        await query.edit_message_text(
            "🤖 **تحلیل چارت با هوش مصنوعی دیگه رویا نیست!**\n\n"
            "با [اندیکاتور اختصاصی نارموون](https://www.tradingview.com/script/HcTUXK3x-Smart-Money-Concepts-Fibonacci-EMA-AI-Enhanced-Analysis/) چارت رو برای هوش مصنوعی آماده کنید و با یک کلیک تحلیل بگیرید.\n\n"
            "✅ **نصب فوری در ۳ مرحله:**\n"
            "۱. وارد لینک بالا بشید\n"
            "۲. دکمه آبی \"Add to Favorites\" رو بزنید ⭐️\n"
            "۳. از بخش Indicators در تریدینگ ویو، اندیکاتور رو به چارت اضافه کنید 📈\n\n"
            "**به همین سادگی!** حالا از چارتتون اسکرین‌شات بگیرید و به هوش مصنوعی نشون بدید تا براتون تحلیل کنه.\n\n"
